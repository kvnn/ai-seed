...
<!-- Describe the product in one or two sentences. What does it do? -->


## Who is it for?

<!-- Describe the person who will use this. What's their role, skill level, and context? -->


## What problem does it solve?

<!-- What pain or gap exists today that this product addresses? -->


## What does "done" look like for v1?

<!-- List 3-5 concrete outcomes that mean the first version is shippable. -->
